...
import 'package:StyleHub/subcategory/productHome.dart';
import 'package:StyleHub/subcategory/productPage.dart';
import 'package:StyleHub/subcategory/subCategoryModel.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
...
class _BrandScreenState extends State<BrandScreen> {
  ...
  CollectionReference brandRef = FirebaseFirestore.instance.collection('SubCategories');


  Future<List<subCategoryModel>> readBrand() async
  {
        ...
        child: GestureDetector(
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ProductPage(seletedBrand: brand, products: [])
              ),
            );
          },
          child: Card(
