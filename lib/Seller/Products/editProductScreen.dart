...
class EditProductScreen extends StatefulWidget {
  ...
  EditProductScreen({Key? key, required this.product, required this.imageUrls, required List<String> image,
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Container(
                ...
                child: Image.file(selectedImages![index], height: 200, width: 200),
              ),
            );
          },
        ),
