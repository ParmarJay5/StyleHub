      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'Welcome to StyleHub! These terms and conditions outline the rules and regulations for the use of StyleHub\'s Website and App, located at www.stylehub.com and StyleHub App. By accessing this Website and App, we assume you accept these terms and conditions. Do not continue to use StyleHub if you do not agree to take all of the terms and conditions stated on this page.',
